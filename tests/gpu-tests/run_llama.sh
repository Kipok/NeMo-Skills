...
# training tests
export NEMO_SKILLS_TEST_NEMO_MODEL=/tmp/nemo-skills-tests/$NEMO_SKILLS_TEST_MODEL_TYPE/conversion/hf-to-nemo/model
export NEMO_SKILLS_TEST_RM_INPUTS_GREEDY=/tmp/nemo-skills-tests/$NEMO_SKILLS_TEST_MODEL_TYPE/vllm-generate-greedy
export NEMO_SKILLS_TEST_RM_INPUTS_SEEDS=/tmp/nemo-skills-tests/$NEMO_SKILLS_TEST_MODEL_TYPE/vllm-generate-seeds
