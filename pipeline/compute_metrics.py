...
class IFEval:
    # loosely adapted from https://github.com/google-research/google-research/blob/master/instruction_following_eval/evaluation_main.py
    def __init__(self):
        self.reset()
    ...
    def is_incomplete(self, elem):
        ...
        return (
            ...
            and 'instruction_id_list' not in elem['loose_eval']
            or 'instruction_id_list' not in elem['strict_eval']
        )
