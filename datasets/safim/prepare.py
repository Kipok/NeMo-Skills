...
URL = "https://huggingface.co/datasets/gonglinyuan/safim/blob/main/{split_name}.jsonl.gz"
...
def save_data(split_name):
    split_name = f"{split_name}_completion_v2" if split_name == "block" else f"{split_name}_completion"
