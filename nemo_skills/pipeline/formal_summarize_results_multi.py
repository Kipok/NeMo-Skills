...
def summarize_results(results_dir: Path, max_samples: int, metrics_calculator):
...
@app.command()
@typer_unpacker
def formal_summarize_results_multi(
    results_dir: str = typer.Argument(
        ...,
        help="Path to the directory containing subdirectories with generation outputs."
    ),
    ...
    """Summarize formalization results in all subdirectories of the specified directory."""
    ...
    for subdir in subdirs:
        ...
        if jsonl_files:
            ...
            summarize_results(subdir, max_samples, metrics_calculator)
        else:
            print(f"No jsonl files found in {subdir}, skipping.")
