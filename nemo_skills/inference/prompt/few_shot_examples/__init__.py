...
assert len(examples_map) == len(examples_gsm8k) + len(examples_math) + len(examples_tabmwp) + len(examples_extraction) + len(examples_proof), "Duplicate keys in examples!"
