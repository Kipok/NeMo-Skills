    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        with tarfile.TarFile(archive_filename, mode="r") as reader_f:
            for tar_member in reader_f:
                ...
                content["new_id"] = f"{eval_set}/{problem_type}/{fileid}.json"
                # Load the solution with our identified fixes
                content["reference_solution"] = _fix_solution(content["new_id"], content["solution"])
                ...
                if len(entries) > 1:
                    parsed_answer = _post_fix_multi_answer(content["new_id"], entries)
                ...
                content["predicted_answer"] = parsed_answer
                ...
                content["predicted_answer"] = _post_fix(content["new_id"], content["predicted_answer"])
